...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _popup__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./popup */ "./js/popup.js");


var openDescription = function openDescription() {
  var descriptionBox = document.querySelectorAll('[data-description]');
  var button = document.querySelector('[data-description-button]');
  descriptionBox.forEach(function (box) {
...
var openAccordion = function openAccordion() {
  ...
  var buttonsMenu = document.querySelectorAll('[data-menu-button]');
  var listsMenu = document.querySelectorAll('[data-menu-list]');
  buttonsMenu.forEach(function (buttonMenu) {
    if (buttonMenu.classList.contains('no-js')) {
      buttonMenu.classList.remove('no-js');
    }
  });
  listsMenu.forEach(function (listMenu) {
  ...
  menu.forEach(function (list) {
    ...
    list.addEventListener('click', function () {
      ...
      if (menuActive.classList.contains('is-active')) {
        ...
        listsMenu.forEach(function (accordionList) {
...
var openPopup = function openPopup() {
  var buttonPopup = document.querySelector('[data-nav-button]');
  var popupOverlay = document.querySelector('.modal');
  var popup = popupOverlay.querySelector('.modal__container');
  var button = popup.querySelector('[data-modal]');
  var inputText = popup.querySelector('[data-modal-input]');
  var inputTel = popup.querySelector('[data-type]');
  var textArea = popup.querySelector('[data-modal-text]');
  var inputCheckbox = popup.querySelector('[data-modal-checkbox]');
  var inputForm = document.querySelector('[data-form-input]');
...
var addMask = function addMask() {
  var inputs = document.querySelectorAll('[data-type]'); // eslint-disable-next-line new-cap

  inputs.forEach(function (input) {
    return Object(imask__WEBPACK_IMPORTED_MODULE_0__["default"])(input, {
